...
<section class="project-detail mt-5">
  <div class="container text-start">
    <div class="col-12 mx-auto">
      <div class="section-background" style="background-image: url('<?php the_field('imagen-detalle-proyecto'); ?>'); background-size: cover; background-position: center; padding: 200px 20px;border-radius:5px">

    <h1 class="project-title text-center" id="titulo" style="color:black;"><?php the_field('titulo_proyecto'); ?></h1>
    ...
    <div class="text-center  tools-section" id="tools">
     ...
     <div class="project-description mt-4">
        <p class="descripcion"><?php the_field('descripcion-1'); ?></p>
     </div>
      <a href="https://abogadosvinadelmar.cl/" target="_blank" class="btn-website ">Visita el sitio</a>
